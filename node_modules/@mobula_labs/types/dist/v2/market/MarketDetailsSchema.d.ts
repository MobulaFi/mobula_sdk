import { z } from 'zod';
declare const MarketDetailsParamsSchema: z.ZodEffects<z.ZodObject<{
...
export declare const MarketDetailsResponseSchema: z.ZodObject<{
    data: z.ZodObject<{
        ...
        perpetuals: z.ZodOptional<z.ZodObject<Omit<{
            ...
            isOpen: z.ZodBoolean;
            assetClass: z.ZodType<import("../perp/PerpModels.ts").AssetClasses>;
            ...
            marketId: string;
            assetClass: import("../perp/PerpModels.ts").AssetClasses;
            defaultTradingFees: {
                makerFeeBps: number;
                takerFeeBps: number;
            };
